    ...
    <>
      <motion.div variants={fadeIn()} initial="initial" animate="animate">
        <div className="flex flex-col h-full h-screen  bg-gradient-to-bl from-rose-100 to-teal-100 dark:bg-info">
          ...
          <h1 className="mt-6 w-11/12 md:w-3/5 mx-auto text-center text-[22px]">{t("description_text")}</h1>
          ...
          <Link
                      className="w-4/5 py-3 md:w-auto mt-6 border rounded-md drop-shadow-lg text-lg border-amber-400 font-semibold mx-auto md:px-9 md:py-3 bg-amber-400 uppercase"
                      activeClass="active"
                      to="project"
                      spy={true}
                      smooth={true}
